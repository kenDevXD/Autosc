...
# ==================================================
# Link Hosting Kalian
kenDevXD="raw.githubusercontent.com/kenDevXD/Autosc/main/wireguard"
...
echo -e "${Info} Wireguard Script By Kenn Hiroyuki"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/kenDevXD/Autosc/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/kenDevXD/Autosc/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/kenDevXD/Autosc/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
